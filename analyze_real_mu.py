...
with model:
    trace = pm.backends.ndarray.load_trace("real-precision")
#
# plot = pm.traceplot(trace)
# plt.savefig("real-precision/trace.png")
...
for i in range(nplot):
    ys = scipy.stats.beta.pdf(vs, alphas[i], betas[i])/np.pi * deg
...
fig.savefig("real-precision/imut_real.pdf")
